                        ...
                        <div class="card-block pt-2 pb-0">
                          <div class="media">
                            <div class="media-body white text-left">
                              <a href="{{url('prix')}}" class="grey darken-1">Formation sur {{$formation->name}}</a>
                              <h4 class="font-medium-5 card-title mb-0">Prix : {{$formation->amount}}</h4>
                            </div>
                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                      <div class="card-block">
                        <div
                          id="line-chart"
                          class="height-300 lineChart lineChartShadow"
                        ></div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                      <div class="col-12 timeline-left" id="activity">
                        <div class="timeline">
                          <ul
                            class="list-unstyled base-timeline activity-timeline"
                          >
                            <li class="">
                            ...
                            <li class="">
                              ...
                              <div class="base-timeline-info">
                                <a href="#" class="text-uppercase text-primary"
                                  >Deal Added</a
                                >
                              </div>
                            ...
                            <li class="">
                              ...
                              <div class="base-timeline-info">
                                <a href="#" class="text-uppercase text-warning"
                                  >Started Task</a
                                >
                              </div>
              ...
              <div class="row match-height">
                <div class="col-xl-4 col-lg-12 col-12">
                  <div class="card">
                    ...
                    <div class="card-body">
                      <p class="font-medium-2 text-muted text-center pb-2">
                        Last 12 Months Sales
                      </p>
                      <div
                        id="Stack-bar-chart"
                        class="height-300 Stackbarchart mb-2"
                      ></div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-xl-6 col-lg-12">
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <div
                        id="donut-dashboard-chart"
                        class="height-250 donut donutShadow"
                      ></div>
